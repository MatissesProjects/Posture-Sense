...
| **004** | [**System Integration**](./tracks/004-system-monitor-integration/index.md) | Monitor layout detection, viewing angle optimization, and eye-tracking contextualization for Windows. | *In Progress* | [Plan](./tracks/004-system-monitor-integration/plan.md) |
